...
echo 'alias munichchain="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/munich/munich-core.git" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/munich/munich-core.git'"
...
rm -rf "$HOME/.config/@munichchain"
rm -rf "$HOME/.config/@munichchain"
rm -rf "$HOME/.config/munichchain-core"
